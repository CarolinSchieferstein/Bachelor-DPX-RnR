...
#                                 August 2018 
#                         Compute Correlational Statistics
#                                 Fragebogen
...
## Korrelationen nur FB
require(psych)
M_FB <- corr.test(Fragebogen_corr_RT[, -c(1,6,11:23)], adjust = 'none')
diag(M_FB$r) = NA
diag(M_FB$p) = NA
...
# Open a pdf file
pdf("./Desktop/corrplot_FR_rew1.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_FR_rew1$r, p.mat = M_FR_rew1$p, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
         number.cex = 1, 
         type = 'upper',
...
# Open a pdf file
pdf("./Desktop/corrplot_FR_rew0.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_FR_rew0$r, p.mat = M_FR_rew0$p, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
         number.cex = 1, 
         type = 'upper',
...
# Open a pdf file
pdf("./Desktop/corrplot_FB_rew0.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_FB_rew0$r, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
...
# Open a pdf file
pdf("./Desktop/corrplot_FB_rew1.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_FB_rew1$r, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
...
# Open a pdf file
pdf("./Desktop/corrplot_RT_A_rew0.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_RT_A_rew0$r, p.mat = M_RT_A_rew0$p, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
...
# Open a pdf file
pdf("./Desktop/corrplot_RT_A_rew1.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_RT_A_rew1$r, p.mat = M_RT_A_rew1$p, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
...
# Open a pdf file
pdf("./Desktop/corrplot_RT_B_rew0.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_RT_B_rew0$r, p.mat = M_RT_B_rew0$p, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
...
# Open a pdf file
pdf("./Desktop/corrplot_RT_B_rew1.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_RT_B_rew1$r, p.mat = M_RT_B_rew1$p, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
...
# Open a pdf file
pdf("./Desktop/corrplot_RT_all_rew0.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_RT_all_rew0$r, p.mat = M_RT_all_rew0$p, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
...
# Open a pdf file
pdf("./Desktop/corrplot_RT_all_rew1.pdf", width = 10 , height = 10) 
# 2. Create a plot
corrplot(M_RT_all_rew1$r, p.mat = M_RT_all_rew1$p, 
         col = rev(colorRampPalette(brewer.pal(11,'RdBu'))(20)),
         method = "circle", 
